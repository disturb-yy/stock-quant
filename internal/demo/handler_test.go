...
func TestRegisterRoutesReturnsDemoStatus(t *testing.T) {
	...
	RegisterRoutes(router.Group("/api/v1"), fakeStatusReader{
		status: DemoStatus{Mode: "demo", Provider: "mysql-demo-fixture", SeedVersion: SeedVersion, Counts: Counts{Instruments: 10, DailyBars: 1210, FinancialMetrics: 16, IndexSnapshots: 124}},
	})
