...
// Validate 检查 fixture 版本及四类实体的领域约束。
func (fixture Fixture) Validate() error {
	...
	if len(fixture.Instruments) == 0 || len(fixture.DailyBars) == 0 || len(fixture.FinancialMetrics) == 0 || len(fixture.IndexSnapshots) == 0 {
		return fmt.Errorf("fixture must contain instruments, daily bars, financial metrics, and index snapshots")
	}
