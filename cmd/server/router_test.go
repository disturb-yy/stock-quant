...
func TestOpenAPIEndpointOverHTTP(t *testing.T) {
	...
	for _, path := range []string{"/api/v1/health", "/api/v1/markets/sectors", "/api/v1/markets/signals", "/api/v1/markets/rankings", "/api/v1/stocks/{symbol}", "/api/v1/stocks/{symbol}/bars", "/api/v1/stocks/{symbol}/financials", "/api/v1/screeners/run", "/api/v1/openapi.json"} {
