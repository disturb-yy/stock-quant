...
func newRouterWithMarketSignalsAndRankingsAndStocks(applicationLogger *slog.Logger, overviewReader interface {
	...
	return newRouterWithMarketSignalsAndRankingsAndStocksAndBars(applicationLogger, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, nil, statusReaders...)
}

func newRouterWithMarketSignalsAndRankingsAndStocksAndBars(applicationLogger *slog.Logger, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
	...
	return newRouterWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancials(applicationLogger, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, barsReader, nil, statusReaders...)
}

func newRouterWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancials(applicationLogger *slog.Logger, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
...
func newRouterWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuation(applicationLogger *slog.Logger, overviewReader interface {
	...
	return newRouterWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuationAndScreenerAndStockPools(applicationLogger, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, barsReader, financialsReader, valuationReader, nil, nil, nil, statusReaders...)
}

func newRouterWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuationAndScreenerAndStockPools(applicationLogger *slog.Logger, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
...
func newHTTPServerWithMarketSignalsAndRankingsAndStocks(applicationLogger *slog.Logger, address string, overviewReader interface {
	...
	return newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBars(applicationLogger, address, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, nil, statusReaders...)
}

func newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBars(applicationLogger *slog.Logger, address string, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
	...
	return newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancials(applicationLogger, address, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, barsReader, nil, statusReaders...)
}

func newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancials(applicationLogger *slog.Logger, address string, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
...
func newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuation(applicationLogger *slog.Logger, address string, overviewReader interface {
	...
	return newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuationAndScreenerAndStockPools(applicationLogger, address, overviewReader, sectorReader, signalReader, rankingReader, stockOverviewReader, barsReader, financialsReader, valuationReader, nil, nil, nil, statusReaders...)
}

func newHTTPServerWithMarketSignalsAndRankingsAndStocksAndBarsAndFinancialsAndValuationAndScreenerAndStockPools(applicationLogger *slog.Logger, address string, overviewReader interface {
	Overview(context.Context) (market.MarketOverview, error)
}, sectorReader interface {
	Sectors(context.Context) (market.MarketSectors, error)
}, signalReader interface {
